...
class NikitaDatabase:
    ...
    def save_watched_reel(self, reel_data: Dict[str, Any], video_local_path: Optional[str] = None) -> bool:
        ...
        self.add_log("REEL_WATCHED", f"Watched new reel {shortcode} from @{username}", {"shortcode": shortcode, "author": username})
        return True
